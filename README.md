...
```
bash <(curl -Ls [bash <(curl -Ls https://raw.githubusercontent.com/ltgjs/3x-ui/v2.6.0/install.sh))
```
...
```
VERSION=v1.7.9 && bash <(curl -Ls "https://raw.githubusercontent.com/ltgjs/3x-ui/$VERSION/install.sh") $VERSION
```
